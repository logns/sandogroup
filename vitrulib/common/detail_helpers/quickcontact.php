...
<input type="hidden" name="propertyid"
	value="<?php echo $property['ROW_ID']?>" /> <input type="hidden"
	name="propertyname"
	value="<?php echo $property['PropertyWebsiteTitle']?>" /> <input
	type="hidden" name="format" value="raw" /> <input type="hidden"
	name="task" value="quickreqashowing" /> <input type="hidden"
	name="view" value="singlepropertyfancy" /> <input type="hidden"
