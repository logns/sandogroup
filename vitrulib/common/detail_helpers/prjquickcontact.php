...
class PrjQuickContact
{
	public function render($projectId, $projectName)
	{
?>
<div id="quickcontact">
...
<input type="hidden" name="projectid"
	value="<?php echo $projectId; ?>" /> <input type="hidden"
	name="propertyname"
	value="<?php echo $projectName; ?>" /> <input
	...
	name="option" value="com_projectsearch" /> <input type="hidden"
