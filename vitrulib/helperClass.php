...
class helperClass {
    ...
    public static function renderCountryCode($id='CountryCode', $name='CountryCode', $class='CountryCode') {
        $selectHtml = '<select name="'. $name .'" id="'. $id .'" class="'. $class .'" required>
                            <option value="" disabled>Enter Country Code</option>
                            <option value="India (+91)" class="selected" selected="selected">India (+91)</option>
