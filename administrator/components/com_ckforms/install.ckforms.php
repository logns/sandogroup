...
function com_install() {
	...
	echo "<br/>Thank you for the installation of CK Forms 1.3.4<br/><br/>If you have any problems, contact <a href=\"mailto:webmaster@cookex.eu\">webmaster@cookex.eu</a><br/>Visit the <a href=\"http://www.cookex.eu\">CK Form web site</a> for the lastest news and update." ;
